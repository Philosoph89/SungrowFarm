...
export SG_RSA_PUBLIC_KEY="$(bashio::config 'rsa_public_key' '')"
export SG_APP_ID="$(bashio::config 'app_id' '')"
export SG_OPENWEATHER_API_KEY="$(bashio::config 'openweather_api_key' '')"
export SG_LATITUDE="$(bashio::config 'latitude' '')"
export SG_LONGITUDE="$(bashio::config 'longitude' '')"
